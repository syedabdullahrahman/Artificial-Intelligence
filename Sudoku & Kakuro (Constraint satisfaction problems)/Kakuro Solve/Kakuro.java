...
// 3. Post constraints
 ...
 /* for example r0 [0] + r0 [1] = bd [1, 3] + bd [1, 4] = 15*/
        ...
        for (i = 0; i < 2; i++) {
            model.arithm(r0[i], ">", 5).post();
        }
        for (i = 0; i < 4; i++) {
            model.arithm(r1[i], ">", 5).post();
        }
        for (i = 0; i < 2; i++) {
            model.arithm(r2[i], "<", 8).post();
        }
        for (i = 0; i < 2; i++) {
            model.arithm(r3[i], "<", 6).post();
        }
        for (i = 0; i < 2; i++) {
 ...
 /* for example c0 [0] + c0 [1] = bd [1, 3] + bd [2, 3] = 17  */
        ...
        for (i = 0; i < 4; i++) {
            model.arithm(c1[i], ">", 4).post();
        }
        for (i = 0; i < 4; i++) {
            model.arithm(c2[i], ">", 5).post();
        }
        for (i = 0; i < 2; i++) {
            model.arithm(c3[i], "<", 8).post();
        }
        for (i = 0; i < 2; i++) {
            model.arithm(c4[i], "<", 8).post();
        }
        for (i = 0; i < 2; i++) {
